...
class AnalyticsSummary(BaseModel):
    ...
    expectancy_usd: float = 0.0         # EV per trade in USD
    expectancy_pct: float = 0.0         # EV per trade in %
    breakeven_win_rate: float = 0.0     # win rate needed to break even
    risk_reward_ratio: float = 0.0      # avg win / avg loss (in %)
    ...
    longest_drawdown_hours: float = 0.0  # time underwater
    recovery_factor: float = 0.0         # total return / max DD
    payoff_ratio: float = 0.0            # avg win USD / avg loss USD
