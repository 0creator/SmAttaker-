...
_PATTERNS = {
    ...
    # ⚠️ V52: BTC on BEP20 (wrapped BTC on BNB Smart Chain) — same EVM
    # hex format as other BEP20/ERC20 addresses, but a DIFFERENT asset
    # and a DIFFERENT wallet. Never confuse with native BTC.
    "btc_bep20": re.compile(r"^0x[0-9a-fA-F]{40}$"),
}
...
_NETWORK_LABELS = {
    ...
    "btc_bep20": "BTC (BEP20 — BNB Smart Chain)",
}
...
def get_safe_wallet_addresses() -> dict:
    ...
    result = {
        ...
        "btc_bep20": _validate("btc_bep20", settings.BTC_BEP20_ADDRESS),
    }
