...
async def sub_callback(update: Update, context: ContextTypes.DEFAULT_TYPE, payload: str):
    ...
    if payload in ("crypto", "plans"):
        ...
        network_icons = {"trc20": "🟢", "erc20": "🔵", "bep20": "🟡", "btc": "🟠", "btc_bep20": "🟤"}
        address_lines_en = ""
        address_lines_ar = ""
...
async def info_callback(update: Update, context: ContextTypes.DEFAULT_TYPE, payload: str):
    ...
    if payload == "about":
        text = t(
            ...
            "📈 *Supported Markets:*\n"
            "• *Crypto:* 35+ major pairs (BTC, ETH, SOL, BNB, etc.) analyzed by SmAttaker.\n"
            "• *Gold, Commodities & Forex:* SmAttaker unified engine also covers XAUUSD, USOIL, GBPUSD, EURUSD, and more.\n\n"
            "🛡️ *Features:*\n"
            ...
            "📈 *الأسواق المدعومة:*\n"
            "• *العملات الرقمية:* أكثر من 35 زوجاً رئيسياً يتم تحليلها بواسطة نموذج SmAttaker.\n"
            "• *الذهب والسلع والعملات:* محرك SmAttaker الموحّد يغطي أيضاً XAUUSD وUSOIL وGBPUSD وEURUSD والمزيد.\n\n"
            "🛡️ *الميزات:*\n"
